<nav class="fixed bottom-0 left-0 w-full flex justify-center bg-white sm:hidden">
    <div class="flex justify-between pb-2 pt-3 w-[92%]">
        <a href="/" class="flex flex-col justify-between items-center text-blue-500">
        ...
        <a href="/wishlist" class="flex flex-col justify-between items-center text-gray-500">
        ...
        <a href="/cart" class="flex flex-col justify-between items-center text-gray-500">
        ...
        <a href="/transaction" class="flex flex-col justify-between items-center text-gray-500">
        ...
        <a href="/profile" class="flex flex-col justify-between items-center text-gray-500">
